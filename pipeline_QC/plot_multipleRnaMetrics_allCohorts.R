...
test <- function(){
  ...
  opt$output <- "//Users/NPK/UMCG/projects/biogen/cohorts/joined_analysis/2019-11-06-freeze2dot1/2019-01-14-QC/"
...
#####
write.table(CombinedMetricsWithFastQC,file=paste0(opt$output,'/2019-04-09-Freeze2.TMM.Covariates.txt'),quote=F, row.names=T, sep='\t')
