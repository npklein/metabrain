...
with gzip.open('/groups/umcg-wijmenga/tmp03/projects/eQTLGen/analysis/cis-eqtl/pcCorrected/output/v1013/2018-01-31-CombinedMetaAnalysis/standardization_for_collaborators/2018-01-31-cis-eQTLs-ProbeLevel-CohortInfoRemoved.txt.gz') as input_file:
...
for disease in qtl_per_disease:
    with open('eqtlgen_disease_overlap/eqtlGen_eQTLsFDR0.05_cis-'+disease+'.txt','w') as out:
