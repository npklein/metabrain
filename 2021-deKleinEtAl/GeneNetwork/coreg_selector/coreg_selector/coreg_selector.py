...
class GetCoreg():
    ...
    def get_coreg_and_zScores(self,gene1, gene2, regions=['all','amyg','basal','cerebellum',
        ...
        return(coreg_scores, pvalues, pvalues_bonf, zscores, regions)
...
def command_line():
    ...
    with  GetCoreg(args.db_location) as get_coreg:
        coreg_scores, pvalues, pvalues_bonf, zscores, regions = get_coreg.get_coreg_and_zScores(args.gene1, args.gene2, args.regions)
