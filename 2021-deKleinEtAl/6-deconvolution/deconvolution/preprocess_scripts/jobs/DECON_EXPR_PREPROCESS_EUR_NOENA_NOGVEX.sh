#!/bin/bash
#SBATCH --job-name=DECON_EXPR_PREPROCESS_EUR_NOENA_NOGVEX
#SBATCH --output=/groups/umcg-biogen/tmp01/output/2019-11-06-FreezeTwoDotOne/2020-10-12-deconvolution/deconvolution/preprocess_scripts/pre_process_decon_expression_matrix/jobs/DECON_EXPR_PREPROCESS_EUR_NOENA_NOGVEX.out
#SBATCH --error=/groups/umcg-biogen/tmp01/output/2019-11-06-FreezeTwoDotOne/2020-10-12-deconvolution/deconvolution/preprocess_scripts/pre_process_decon_expression_matrix/jobs/DECON_EXPR_PREPROCESS_EUR_NOENA_NOGVEX.out
